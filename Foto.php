    ...
    <section class="row center">
        <div class="col-lg-6">
            <div class="col-md-6  center" >
                <img src="./kalendadi/attels1.jpg" alt="kalendars" width="250"
                     height="200">
            </div>
            <div class="col-md-6 center">
                <img src="./kalendadi/attels2.jpg" alt="kalendars" width="250"
                     height="200">
            </div>
        </div>
        ...
        <div class="col-lg-6">
            <div class="col-md-6 center">
                <img src="./kalendadi/attels3.png" alt="kalendars" width="250"
                     height="200">
            </div>
            <div class="col-md-6 center">
                <img src="./kalendadi/attels4.jpg" alt="kalendars" width="250"
                     height="200">
            </div>
        </div>
